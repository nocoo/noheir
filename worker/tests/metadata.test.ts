...
describe("metadata repo", () => {
  ...
  test("years: UNION DISTINCT from transactions + transfers, sorted DESC", async () => {
    ...
    await repos.transactions.create(userId, {
      ...
      primaryCategory: "餐饮", tertiaryCategory: "午餐",
      amountCents: 1000, type: "expense", account: "招商银行",
    });
    await repos.transactions.create(userId, {
      date: "2025-12-01", year: 2025, month: 12, day: 1,
      primaryCategory: "餐饮", tertiaryCategory: "午餐",
      amountCents: 1000, type: "expense", account: "招商银行",
    });
    await repos.transfers.create(userId, {
      date: "2024-06-01", year: 2024, month: 6, day: 1,
      account: "支付宝",
    });
  ...
  test("accounts: UNION DISTINCT from both tables, sorted ASC", async () => {
    ...
    await repos.transactions.create(userId, {
      ...
      primaryCategory: "A", tertiaryCategory: "B",
      amountCents: 100, type: "expense", account: "招商银行",
    });
    await repos.transfers.create(userId, {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      account: "支付宝",
    ...
    await repos.transfers.create(userId, {
      date: "2026-01-02", year: 2026, month: 1, day: 2,
  ...
  test("categories: DISTINCT primary_category from transactions, sorted ASC", async () => {
    ...
    const base = {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      tertiaryCategory: "X", amountCents: 100, type: "expense" as const, account: "A",
    };
  ...
  test("secondary_categories: excludes null and empty", async () => {
    ...
    const base = {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      primaryCategory: "A", tertiaryCategory: "B",
      amountCents: 100, type: "expense" as const, account: "X",
    };
  ...
  test("currencies: UNION from both tables", async () => {
    ...
    await repos.transactions.create(userId, {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      primaryCategory: "A", tertiaryCategory: "B",
      amountCents: 100, type: "expense", account: "X", currency: "人民币",
    });
    await repos.transfers.create(userId, {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      account: "Y", currency: "USD",
    });
  ...
  test("transaction_count and transfer_count", async () => {
    ...
    await repos.transactions.create(userId, {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      primaryCategory: "A", tertiaryCategory: "B",
      amountCents: 100, type: "expense", account: "X",
    });
    await repos.transactions.create(userId, {
      date: "2026-01-02", year: 2026, month: 1, day: 2,
      primaryCategory: "A", tertiaryCategory: "B",
      amountCents: 200, type: "expense", account: "X",
    });
    await repos.transfers.create(userId, {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      account: "Y",
  ...
  test("user isolation", async () => {
    ...
    await repos.transactions.create("other-user", {
      date: "2026-01-01", year: 2026, month: 1, day: 1,
      primaryCategory: "C", tertiaryCategory: "D",
      amountCents: 200, type: "income", account: "Y",
    });
