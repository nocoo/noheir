...
export const TAG_COLORS = {
  ...
  // General (18 hues)
  slate: {
    label: "bg-slate-100 dark:bg-slate-700/30",
    text: "text-slate-700 dark:text-slate-300",
  },
  red: {
    label: "bg-red-50 dark:bg-red-500/10",
    text: "text-red-700 dark:text-red-300",
  },
  orange: {
    label: "bg-orange-50 dark:bg-orange-500/10",
    text: "text-orange-700 dark:text-orange-300",
  },
  amber: {
    label: "bg-amber-50 dark:bg-amber-500/10",
    text: "text-amber-700 dark:text-amber-300",
  },
  yellow: {
    label: "bg-yellow-50 dark:bg-yellow-500/10",
    text: "text-yellow-700 dark:text-yellow-200",
  },
  lime: {
    label: "bg-lime-50 dark:bg-lime-500/10",
    text: "text-lime-700 dark:text-lime-300",
  },
  green: {
    label: "bg-green-50 dark:bg-green-500/10",
    text: "text-green-700 dark:text-green-300",
  },
  emerald: {
    label: "bg-emerald-50 dark:bg-emerald-500/10",
    text: "text-emerald-700 dark:text-emerald-300",
  },
  teal: {
    label: "bg-teal-50 dark:bg-teal-500/10",
    text: "text-teal-700 dark:text-teal-300",
  },
  cyan: {
    label: "bg-cyan-50 dark:bg-cyan-500/10",
    text: "text-cyan-700 dark:text-cyan-300",
  },
  sky: {
    label: "bg-sky-50 dark:bg-sky-500/10",
    text: "text-sky-700 dark:text-sky-300",
  },
  blue: {
    label: "bg-blue-50 dark:bg-blue-500/10",
    text: "text-blue-700 dark:text-blue-300",
  },
  indigo: {
    label: "bg-indigo-50 dark:bg-indigo-500/10",
    text: "text-indigo-700 dark:text-indigo-300",
  },
  violet: {
    label: "bg-violet-50 dark:bg-violet-500/10",
    text: "text-violet-700 dark:text-violet-300",
  },
  purple: {
    label: "bg-purple-50 dark:bg-purple-500/10",
    text: "text-purple-700 dark:text-purple-300",
  },
  fuchsia: {
    label: "bg-fuchsia-50 dark:bg-fuchsia-500/10",
    text: "text-fuchsia-700 dark:text-fuchsia-300",
  },
  pink: {
    label: "bg-pink-50 dark:bg-pink-500/10",
    text: "text-pink-700 dark:text-pink-300",
  },
  rose: {
    label: "bg-rose-50 dark:bg-rose-500/10",
...
export function getLabelColorClasses(label: string): {
  ...
  if ("bg" in color && "border" in color) {
...
export function getUnitCodeColorClasses(unitCode: string): {
  ...
  return getLabelColorClasses(getUnitCodePrefix(unitCode));
}
