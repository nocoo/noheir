...
describe("buildMonthlyData", () => {
  it("aggregates income and expense by month", () => {
    const txs = [
      { id: "1", date: "2026-01-01", year: 2026, month: 1, primaryCategory: "工资", secondaryCategory: null, tertiaryCategory: "", amount: 10000, account: "A", type: "income" as const, currency: "CNY", tags: [], note: null },
      { id: "2", date: "2026-01-15", year: 2026, month: 1, primaryCategory: "餐饮", secondaryCategory: null, tertiaryCategory: "", amount: 3000, account: "A", type: "expense" as const, currency: "CNY", tags: [], note: null },
      { id: "3", date: "2026-02-01", year: 2026, month: 2, primaryCategory: "工资", secondaryCategory: null, tertiaryCategory: "", amount: 8000, account: "A", type: "income" as const, currency: "CNY", tags: [], note: null },
    ]
  ...
  it("skips transactions with invalid month index", () => {
    const txs = [
      { id: "1", date: "2026-13-01", year: 2026, month: 13, primaryCategory: "", secondaryCategory: null, tertiaryCategory: "", amount: 100, account: "A", type: "income" as const, currency: "CNY", tags: [], note: null },
    ]
    const result = buildMonthlyData(txs)
