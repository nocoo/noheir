export const toggleCategory = (categories: string[], category: string): string[] => {
...
export const toggleAllInGroup = (categories: string[], group: string[]): string[] => {
...
export const countSelectedInGroup = (categories: string[], group: string[]): number => {
