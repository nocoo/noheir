...
export const buildTotalExpense = (transactions: Transaction[]) => {
  return transactions
    .filter(t => t.type === 'expense')
    .reduce((sum, t) => sum + t.amount, 0);
};

export const buildFreedomSummary = (totalExpense: number, passiveIncome: number): FinancialFreedomSummary => {
