...
function toDomainTransfer(raw: Record<string, unknown>): DomainTransfer {
  return {
    ...
    primaryCategory: raw.primary_category != null ? String(raw.primary_category) : null,
    secondaryCategory: raw.secondary_category != null ? String(raw.secondary_category) : null,
    transactionType: raw.transaction_type != null ? String(raw.transaction_type) : null,
    inflowAmount: Number(raw.inflow_amount_cents ?? 0) / 100,
    outflowAmount: Number(raw.outflow_amount_cents ?? 0) / 100,
