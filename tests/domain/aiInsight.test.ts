...
import { buildInsightSummaryData, sortInsightsByPriority, sortRecurringPaymentsByNextDate } from '../../src/domain/dashboard/aiInsight';

describe('aiInsight domain', () => {
  it('builds summary data', () => {
    const summary = buildInsightSummaryData([
      {
        id: 'p1',
        description: 'A',
        account: 'A',
